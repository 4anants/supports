    ...
    useEffect(() => {
        const fetchTicket = async () => {
            try {
                ...
                const record = await pb.collection('tickets').getFirstListItem(`generated_id="${cleanId}"`);
                setTicket(record);
            } catch (err) {
                console.error(err);
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 border-b border-gray-100">
                                    <div>
                                        ...
                                        <p className="font-medium text-gray-800">{ticket.full_name}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <p className="mt-1 text-gray-700 leading-relaxed bg-gray-50 p-4 rounded-lg border border-gray-100">
                                            {ticket.description}
                                        </p>
                                    </div>
                                </div>
